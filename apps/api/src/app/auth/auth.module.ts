...
@Module({
  ...
  providers: [JwtStrategy, AuthService, authFieldsProvider, ...oauthProviders, PostService],
  exports: [JwtModule, AuthService, NestAuthModule, authFieldsProvider, PostService],
